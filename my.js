(function ($) {
    ...
    // $("#myAlert").show("slow").delay(1000).hide("slow");
    let r = Math.floor((Math.random() * 5757) + 0)
    let secret = word_list[r];
    // to view secret word
    console.log(secret);
    let i = 1;
    let row = 1;
    document.getElementById("myBtn").onclick = function () {
        ...
        if (input.length != 5) {
            $("#not5").show("slow").delay(1000).hide("slow");
            return;
        }
        if (!word_list.includes(input)) {
            $("#notword").show("slow").delay(1000).hide("slow");
            return;
        }
            ...
            for (let col = 0; col < 5; col++) {
                ...
                document.getElementById("mySpan").innerHTML = secret.toUpperCase();
                $('#win').modal('toggle');
        }
        else {
            for (let col = 0; col < 5; col++) {
                    ...
                    for (let m = 0; m < 5; m++) {
                        if (col != m && secret[m] == input[col]) {
                            ...
                            if (!($("#cell-" + input[col]).hasClass("cell-green"))) {
                                $("#cell-" + input[col]).addClass("cell-yellow");
                            }
        ...
        i += 1;
        if (i > 6) {
            document.getElementById("losespan").innerHTML = secret.toUpperCase();
            $('#lose').modal('toggle');
            return;
        }
    };
